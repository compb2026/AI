...
Chat: A utility from NLTK to create rule-based chatbots using pattern matching.

reflections: A dictionary that maps first-person pronouns to second-person (like "I am" → "you are") to make conversations more natural.



Prints a welcome message.

Creates a Chat object using:

pairs: your list of patterns and responses.

reflections: handles word substitutions like I → you, am → are, etc.

chat.converse(): Starts an infinite loop, waiting for user input and responding.



if __name__== "__main__":
    chat()
If this file is run directly (not imported as a module), the chat() function starts.
'''